...
While aligning, the loop appends one row per frame (time since start, raw and smoothed egg cx
and h, commanded x/y velocities, result) to `captures/<YYYYmmdd-HHMMSS>-align.csv`, stamped at the
...
TRACE_COLUMNS = ("t", "cx_raw", "h_raw", "cx_smooth", "h_smooth", "x_vel", "y_vel", "result")
