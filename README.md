...
This repository currently contains planning documents and SO101 reference models. Robot control, attendee controller software, and custom 3D parts are planned; the directory scaffold does not establish working control software.
