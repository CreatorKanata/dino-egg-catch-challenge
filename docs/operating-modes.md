<!-- docs/operating-modes.md: Record the owner-decided operating modes, their triggers, and what each needs before it can run on the robot. -->
# Operating Modes
...
This document supersedes the three-mode table in [concept.md](concept.md) (Drive, Puppet, Autonomous). Drive Mode and Puppet Mode run at the same time as Manual Mode; the autonomous experience is split into Auto Catch, Auto Release, and Full Self Catch.
