...
Use actual STEP geometry and measured hardware for fitting. Generated appearance images are design references, not dimensional evidence. See the [concept](../docs/proposals/concept.md) for appearance constraints and fabrication proposals.
